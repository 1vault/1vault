...
export function SiteFooter() {
  return (
    <footer className="relative overflow-hidden border-t border-line px-6 pt-12 md:px-10">
      ...
      <div className="relative mx-auto w-full max-w-[1240px]">
        ...
        <div className="mt-10 flex flex-col gap-4 border-t border-line py-8 sm:flex-row sm:items-center sm:justify-between">
